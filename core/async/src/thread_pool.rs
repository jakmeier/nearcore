...
/// Background contract compilation, including state sync and contract
/// distribution precompiles.
const PRIORITY_BACKGROUND_CONTRACT_COMPILATION: u8 = 10;
...
pub fn background_contract_compilation_pool() -> &'static Arc<ThreadPool> {
    ...
    POOL.get_or_init(|| {
        ...
        Arc::new(ThreadPool::new(
            ...
            Duration::from_hours(1),
            thread_limit,
            PRIORITY_BACKGROUND_CONTRACT_COMPILATION,
        ))
    })
}
